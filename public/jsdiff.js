...
function check(){
    ...
    var a = document.getElementById('baseText');
    var b = document.getElementById('newText');
    ...
    /*
    var oldStr = document.getElementById('baseText').value;
    var newStr = document.getElementById('newText').value;*/
